...
const localeSlugMap: Record<string, Record<string, string>> = {
  ...
  'meta-tags': { fr: 'meta-tags', en: 'meta-tags' },
  'sitemap-robots': { fr: 'sitemap-robots', en: 'sitemap-robots' },
  ...
  'css-gradient': { fr: 'css-gradient', en: 'css-gradient' },
  'markdown-preview': { fr: 'markdown-preview', en: 'markdown-preview' },
  ...
  'lorem-ipsum': { fr: 'lorem-ipsum', en: 'lorem-ipsum' },
  ...
  'color-picker': { fr: 'color-picker', en: 'color-picker' },
  ...
  'generateur-nombres-aleatoires': { fr: 'generateur-nombres-aleatoires', en: 'random-number-generator' },
  ...
  'calculateur-pourboire': { ar: 'حاسبة-البقشيش', de: 'trinkgeldrechner', en: 'tip-calculator', es: 'calculadora-porcentaje', pt: 'calculadora-gorjeta' },
}
