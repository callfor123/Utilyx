...
export const seoRegistry: Record<string, ToolSeoEntry> = {
  ...
  'compteur-mots': {
    ...
    desc: 'Comptez les mots, caractères, phrases et paragraphes de votre texte en temps réel. Temps de lecture, gratuit, sans inscription.',
  ...
  'convertisseur-casse': {
    ...
    desc: 'Convertissez votre texte en majuscules, minuscules, camelCase, snake_case et plus. 9 formats, gratuit, sans inscription.',
  ...
  'lorem-ipsum': {
    ...
    desc: 'Générez du texte Lorem Ipsum placeholder pour vos maquettes et designs. Paragraphe ou mots, gratuit, sans inscription.',
