...
export const seoRegistry: Record<string, ToolSeoEntry> = {
  ...
  'convertisseur-unites': {
    ...
    desc: 'Convertissez entre unités de longueur, poids, température, volume, vitesse et plus avec 50+ unités supportées. Outil gratuit en ligne, sans inscription.',
  ...
  'timer-pomodoro': {
    ...
    desc: 'Timer Pomodoro gratuit avec sessions de travail personnalisables, pauses courtes et longues pour améliorer votre productivité. Sans inscription, 100% local.',
