...
export const seoRegistry: Record<string, ToolSeoEntry> = {
  ...
  'fusionner-pdf': {
    ...
    h1: 'Fusionner plusieurs PDF en un seul fichier gratuitement en ligne',
  ...
  'pdf-en-images': {
    ...
    h1: 'Convertir un PDF en images JPG ou PNG en ligne gratuitement',
  ...
  'signer-pdf': {
    ...
    h1: 'Signer un document PDF en ligne gratuitement',
  ...
  'deverrouiller-pdf': {
    ...
    h1: 'Déverrouiller un PDF protégé par mot de passe en ligne gratuitement',
  ...
  'proteger-pdf': {
    ...
    desc: 'Protégez vos PDF avec un mot de passe et un chiffrement AES-256. Sécurisez vos documents confidentiels gratuitement en ligne, sans inscription.',
    h1: 'Protéger un PDF avec un mot de passe en ligne gratuitement',
  ...
  'convertir-image': {
    ...
    title: 'Convertisseur Image en Ligne Gratuit — WebP, AVIF, JPG, PNG',
    ...
    h1: 'Convertir des images en WebP, AVIF, JPG, PNG en ligne gratuitement',
  ...
  'supprimer-arriere-plan': {
    ...
    desc: 'Supprimez l\'arrière-plan de vos images gratuitement avec détourage IA automatique. Résultat PNG transparent, sans inscription, 100% local.',
    h1: 'Supprimer l\'arrière-plan d\'une image gratuitement en ligne',
  ...
  'heic-vers-jpg': {
    ...
    desc: 'Convertissez vos photos iPhone HEIC en JPG ou PNG universellement compatibles. Conversion par lot, qualité préservée, gratuit et sans inscription.',
    h1: 'Convertir des photos HEIC en JPG ou PNG gratuitement en ligne',
  ...
  'ocr-image': {
    ...
    h1: 'Extraire du texte d\'une image avec OCR gratuitement en ligne',
  ...
  'generateur-favicon': {
    ...
    h1: 'Générer un favicon pour votre site web gratuitement en ligne',
  ...
  'telecharger-miniature-youtube': {
    ...
    h1: 'Télécharger la miniature d\'une vidéo YouTube gratuitement en ligne',
  ...
  'decouper-video': {
    ...
    desc: 'Coupez et découpez vos vidéos en quelques secondes sans réencodage. Prévisualisation en temps réel, précision milliseconde, gratuit et sans inscription.',
  ...
  'ajouter-audio-video': {
    ...
    desc: 'Ajoutez une musique ou une voix-off à votre vidéo avec mixage volume indépendant. Fusionnez MP3 et vidéo gratuitement en ligne, sans inscription.',
    h1: 'Ajouter de l\'audio à une vidéo en ligne gratuitement',
  ...
  'extraire-audio-video': {
    ...
    desc: 'Extrayez la piste audio de vos vidéos en MP3, WAV ou AAC avec choix du bitrate. Isolation rapide et gratuite en ligne, sans inscription.',
    h1: 'Extraire l\'audio d\'une vidéo en ligne gratuitement',
  ...
  'video-en-gif': {
    ...
    h1: 'Convertir une vidéo en GIF animé en ligne gratuitement',
  ...
  'supprimer-audio-video': {
    ...
    desc: 'Retirez la piste audio d\'une vidéo en un clic pour obtenir une vidéo silencieuse sans réencodage. Outil gratuit en ligne, sans inscription, 100% local.',
    h1: 'Supprimer l\'audio d\'une vidéo en ligne gratuitement',
  ...
  'json-csv': {
    ...
    desc: 'Convertissez et formatez vos données JSON et CSV facilement avec import/export Excel. Outil gratuit en ligne, sans inscription, 100% local.',
    h1: 'Convertir JSON en CSV et inversement gratuitement en ligne',
  ...
  'testeur-regex': {
    ...
    h1: 'Tester une expression régulière en ligne gratuitement',
  ...
  'meta-tags': {
    ...
    h1: 'Générer et prévisualiser les meta tags SEO gratuitement en ligne',
  ...
  'sitemap-robots': {
    ...
    desc: 'Générez un sitemap XML et un fichier robots.txt pour optimiser le référencement Google de votre site web. Outil gratuit en ligne, sans inscription.',
    h1: 'Générer un sitemap XML et un robots.txt gratuitement en ligne',
  ...
  'formateur-json': {
    ...
    desc: 'Formatez, validez et minifiez votre JSON en un clic avec coloration syntaxique. Détection d\'erreurs en temps réel, gratuit et sans inscription.',
    h1: 'Formater et valider du JSON en ligne gratuitement',
  ...
  'url-encode-decode': {
    ...
    desc: 'Encodez et décodez des URLs et paramètres de requête avec support Unicode et emojis. Outil pour développeurs gratuit en ligne, sans inscription.',
    h1: 'Encoder et décoder une URL en ligne gratuitement',
  ...
  'css-gradient': {
    ...
    desc: 'Créez des dégradés CSS linéaires et radiaux visuellement avec code copiable. Aperçu en temps réel, gratuit en ligne et sans inscription.',
  ...
  'markdown-preview': {
    ...
    desc: 'Éditeur Markdown avec aperçu en temps réel, support tableaux, code et LaTeX. Rédigez et prévisualisez gratuitement en ligne, sans inscription.',
    h1: 'Éditeur Markdown avec aperçu en direct gratuitement en ligne',
  ...
  'nettoyeur-url-tracking': {
    ...
    desc: 'Supprimez les paramètres de tracking (UTM, fbclid, etc.) de vos liens pour des URLs propres. 200+ paramètres détectés, gratuit, sans inscription.',
    h1: 'Nettoyer une URL des paramètres de tracking gratuitement en ligne',
  ...
  'base64': {
    ...
    desc: 'Encodez et décodez du texte et des fichiers en Base64 (standard et URL-safe). Traitement 100% local, gratuit, sans inscription.',
    h1: 'Encoder et décoder en Base64 en ligne gratuitement',
  ...
  'comparateur-texte': {
    ...
    h1: 'Comparer deux textes et voir les différences gratuitement en ligne',
  ...
  'separateur-nom-prenom': {
    ...
    h1: 'Séparer prénoms et noms de famille en ligne gratuitement',
  ...
  'generateur-mot-de-passe': {
    ...
    title: 'Générateur Mot de Passe en Ligne Gratuit — Mots de Passe Sécurisés',
    desc: 'Générez des mots de passe forts et aléatoires avec longueur et caractères personnalisables. Indicateur de force en temps réel, gratuit et 100% local.',
  ...
  'color-picker': {
    ...
    desc: 'Choisissez une couleur et obtenez ses valeurs HEX, RGB et HSL avec pipette intégrée. Sélecteur de couleur gratuit en ligne, sans inscription.',
  ...
  'generateur-lien-whatsapp': {
    ...
    desc: 'Créez un lien direct vers WhatsApp avec message pré-rempli au format wa.me. Idéal pour le marketing et le service client, gratuit et sans inscription.',
  ...
  'convertisseur-couleurs': {
    ...
    desc: 'Convertissez les couleurs entre HEX, RGB, HSL et CMYK pour l\'impression et le web. Sélecteur intégré, gratuit en ligne et sans inscription.',
  ...
  'convertisseur-unites': {
    ...
    title: 'Convertisseur d\'Unités en Ligne Gratuit — Longueur, Poids, Température, Volume, Vitesse',
    desc: 'Convertissez entre unités de longueur, poids, température, volume, vitesse, surface et temps avec 50+ unités supportées. Formules affichées, gratuit, sans inscription.',
    h1: 'Convertir des unités en ligne gratuitement',
    intro: 'Convertissez instantanément entre toutes les unités de mesure courantes : longueur (m, km, mi, ft, in, cm, mm, yd), poids (kg, lb, oz, g, t), température (°C, °F, K), volume (L, gal, fl oz, mL, m³), vitesse (km/h, mph, m/s, nœuds), surface (m², ha, acre, ft²) et temps (s, min, h, jours). Le convertisseur d\'unités est un outil indispensable au quotidien : les voyageurs passent du système métrique à impérial, les cuisiniers adaptent des recettes anglo-saxonnes, les étudiants en sciences manipulent des unités SI, les ingénieurs convertissent des spécifications techniques internationales, et les sportifs comparent des performances en miles ou kilomètres. Notre outil couvre 7 catégories de mesures avec plus de 50 unités, et les conversions s\'effectuent en temps réel au fur et à mesure de la saisie. Les formules de conversion sont affichées pour référence éducative, ce qui en fait aussi un outil pédagogique précieux. Par exemple, découvrez que 1 mile = 1,60934 km, que 0°C = 32°F, ou que 1 gallon US = 3,78541 litres. Chaque conversion est calculée avec une précision décimale adaptée, évitant les erreurs d\'arrondi courantes dans les calculs manuels. Le calcul s\'effectue localement dans votre navigateur — aucune donnée n\'est envoyée à un serveur. Le service est gratuit et sans inscription.',
    faq: [
      { q: 'Est-ce gratuit et sans inscription ?', a: 'Oui, 100% gratuit et sans inscription. Convertissez autant d\'unités que vous le souhaitez, sans limite quotidienne.' },
      { q: 'Quelles catégories d\'unités sont disponibles ?', a: 'Longueur, poids/masse, température, volume, vitesse, surface et temps — plus de 50 unités au total couvrant les systèmes métrique, impérial et US.' },
      { q: 'Comment convertir des températures ?', a: 'Entrez la valeur et sélectionnez l\'unité source. Les conversions en Celsius, Fahrenheit et Kelvin s\'affichent instantanément. Formule : °F = (°C × 9/5) + 32.' },
      { q: 'Quelle est la différence entre gallons US et gallons impériaux ?', a: '1 gallon US = 3,78541 litres, tandis que 1 gallon impérial (UK) = 4,54609 litres. Notre outil distingue les deux pour éviter toute confusion dans vos recettes ou calculs.' },
      { q: 'Les conversions sont-elles précises ?', a: 'Oui, chaque conversion utilise les facteurs de conversion officiels du BIPM (Bureau International des Poids et Mesures). Les résultats sont affichés avec la précision adaptée à chaque unité.' },
      { q: 'Puis-je convertir des unités de surface ?', a: 'Oui, la catégorie Surface propose m², km², ha, acre, ft², yd², mi² et bien d\'autres. Parfait pour l\'immobilier, l\'agriculture ou l\'urbanisme.' }
    ],
    howTo: ['Sélectionnez la catégorie d\'unités (longueur, poids, température, etc.)', 'Entrez la valeur à convertir dans le champ de saisie', 'Choisissez l\'unité source dans le menu déroulant', 'Tous les résultats dans les autres unités s\'affichent instantanément', 'Consultez la formule de conversion affichée sous les résultats'],
    relatedSlugs: ['calculateur-pourcentage', 'convertisseur-couleurs', 'convertisseur-temps'],
  },
  'calculateur-dosage-beton': {
    ...
    desc: 'Calculez les volumes de ciment, sable et gravier pour votre dosage béton. Résultats en kg et sacs, dosages standards, gratuit et sans inscription.',
  ...
  'calculateur-frais-kilometriques': {
    ...
    desc: 'Calculez vos indemnités kilométriques selon le barème URSSAF pour voitures, motos et cyclomoteurs. Outil fiscal gratuit en ligne, sans inscription.',
  ...
  'chronometre': {
    ...
    desc: 'Chronomètre en ligne gratuit avec tours intermédiaires et précision au centième de seconde. Idéal pour le sport et le suivi de tâches.',
  ...
  'timer-pomodoro': {
    ...
    desc: 'Timer Pomodoro gratuit avec sessions de travail personnalisables, pauses courtes et longues, notifications sonores. Améliorez votre concentration, sans inscription.',
    h1: 'Timer Pomodoro — Technique de productivité',
    intro: 'Boostez votre productivité avec la technique Pomodoro grâce à notre timer en ligne avec interface visuelle et paramètres entièrement personnalisables. La technique Pomodoro, inventée par Francesco Cirillo dans les années 1980, alterne des périodes de travail concentré (traditionnellement 25 minutes) avec des pauses courtes (5 minutes), et une pause longue tous les 4 cycles (15-30 minutes). Cette méthode simple mais puissante exploite la pression du temps pour maintenir la concentration et prévenir la procrastination. Des études en neurosciences montrent que les pauses régulières améliorent la rétention d\'information et réduisent la fatigue mentale : le cerveau consolide les apprentissages pendant les moments de repos. Notre timer vous guide à travers chaque phase avec des notifications sonores et visuelles, et affiche le nombre de Pomodoros complétés dans la session. Vous pouvez personnaliser la durée des sessions de travail (5 à 60 minutes), des pauses courtes (1 à 15 minutes), des pauses longues (5 à 30 minutes) et le nombre de cycles avant la pause longue. Les étudiants l\'utilisent pour réviser efficacement, les développeurs pour coder en flux continu, les rédacteurs pour structurer leurs sessions d\'écriture, et les freelances pour organiser leurs journées. Le timer fonctionne même si vous changez d\'onglet ou minimisez le navigateur. Le service est gratuit et sans inscription — aucune installation requise.',
    faq: [
      { q: 'Qu\'est-ce que la technique Pomodoro ?', a: 'Travaillez 25 minutes en concentration totale, prenez une pause de 5 minutes, puis recommencez. Après 4 Pomodoros, prenez une pause longue de 15 à 30 minutes. Cette méthode exploite l\'urgency principle pour maintenir la concentration.' },
      ...
      { q: 'Le timer fonctionne-t-il en arrière-plan ?', a: 'Oui, le timer continue de fonctionner même si vous changez d\'onglet, avec des notifications sonores pour chaque transition entre travail et pause.' },
      { q: 'Pourquoi 25 minutes est-il le temps recommandé ?', a: '25 minutes est la durée optimale identifiée par Francesco Cirillo : assez courte pour maintenir la concentration, assez longue pour accomplir une tâche significative. Mais vous pouvez ajuster selon votre rythme personnel — certains préfèrent 50/10 ou 15/3.' },
      { q: 'Que faire si je suis interrompu pendant un Pomodoro ?', a: 'La règle Pomodoro est stricte : si vous êtes interrompu, le Pomodoro est invalidé et doit être recommencé. Notez l\'interruption, traitez-la pendant la pause, puis relancez un nouveau Pomodoro.' },
      { q: 'Le Pomodoro est-il adapté à tous les types de travail ?', a: 'Le Pomodoro est idéal pour le travail intellectuel nécessitant de la concentration : rédaction, programmation, études, design. Pour les tâches créatives nécessitant un flux continu, des sessions plus longues (50-90 min) peuvent être plus adaptées.' }
    ],
    howTo: ['Configurez la durée de travail (25 min par défaut) et des pauses (5 min courte, 15 min longue)', 'Cliquez sur Démarrer pour commencer le premier Pomodoro', 'Travaillez avec concentration jusqu\'à la fin de la session', 'Prenez la pause courte — le timer bascule automatiquement', 'Après 4 Pomodoros, prenez une pause longue pour recharger votre énergie'],
    relatedSlugs: ['chronometre', 'calculateur-age', 'convertisseur-temps'],
  },
  'calculateur-tva': {
  ...
  'calculateur-pourboire': {
    ...
    desc: 'Calculez le pourboire et répartissez l\'addition entre plusieurs personnes. Pourcentage personnalisable, arrondi intelligent, gratuit et sans inscription.',
  ...
  'convertisseur-temps': {
    ...
    title: 'Convertisseur de Temps en Ligne Gratuit — Secondes, Minutes, Heures, Jours, Semaines',
    desc: 'Convertissez instantanément entre secondes, minutes, heures, jours, semaines, mois et années avec formules affichées. Gratuit, sans inscription, 100% local.',
    h1: 'Convertisseur de temps : secondes, minutes, heures, jours, semaines',
    intro: 'Convertissez facilement une durée entre toutes les unités de temps : millisecondes, secondes, minutes, heures, jours, semaines, mois et années. Entrez une valeur dans n\'importe quelle unité et obtenez instantanément la conversion dans toutes les autres. Parfait pour calculer des durées de projet, convertir des temps de travail, planifier des événements, comprendre des délais contractuels ou simplement convertir une durée exprimée dans une unité différente. Par exemple, transformez 90 minutes en 1,5 heure, 72 heures en 3 jours, ou 2 semaines en 14 jours. Les professionnels utilisent cet outil pour estimer des charges de travail, les étudiants pour résoudre des problèmes de mathématiques, et les assistants de direction pour convertir des délais de livraison. Les conversions utilisent les valeurs standards : 1 minute = 60 secondes, 1 heure = 60 minutes, 1 jour = 24 heures, 1 semaine = 7 jours, 1 mois = 30,44 jours (moyenne), 1 an = 365,25 jours (moyenne incluant les années bissextiles). Les formules de conversion sont affichées pour référence éducative. Le calcul s\'effectue localement dans votre navigateur — aucune donnée n\'est envoyée à un serveur. Le service est gratuit et sans inscription.',
    faq: [
      ...
      { q: 'Comment sont calculés les mois et années ?', a: 'Un mois est calculé comme 30,44 jours en moyenne (365,25 / 12) et une année comme 365,25 jours (incluant les années bissextiles). Ces valeurs sont des moyennes internationalement reconnues.' },
      { q: 'Puis-je convertir des durées en millisecondes ?', a: 'Oui, l\'outil prend en charge les millisecondes pour les besoins techniques et scientifiques. Par exemple, 1 seconde = 1 000 millisecondes.' },
      { q: 'À quoi sert un convertisseur de temps au quotidien ?', a: 'Il est utile pour calculer des temps de travail (heures en jours), planifier des projets (semaines en jours), comprendre des délais contractuels, convertir des durées de vidéos ou de recettes, et résoudre des exercices de mathématiques impliquant des unités de temps.' },
    ],
