...
E.append({
'slug':'decouper-video','toolId':'video-trim','category':'video',
...
E.append({
'slug':'compresser-video','toolId':'video-compress','category':'video',
...
E.append({
'slug':'convertir-video','toolId':'video-convert','category':'video',
...
E.append({
'slug':'ajouter-audio-video','toolId':'video-add-audio','category':'video',
...
E.append({
'slug':'extraire-audio-video','toolId':'video-extract-audio','category':'video',
...
E.append({
'slug':'video-en-gif','toolId':'video-to-gif','category':'video',
...
E.append({
'slug':'supprimer-audio-video','toolId':'video-remove-audio','category':'video',
...
E.append({
'slug':'json-csv','toolId':'json-csv','category':'dev-seo',
...
E.append({
'slug':'testeur-regex','toolId':'regex-tester','category':'dev-seo',
...
E.append({
'slug':'meta-tags','toolId':'meta-tags','category':'dev-seo',
...
E.append({
'slug':'sitemap-robots','toolId':'sitemap-robots','category':'dev-seo',
...
E.append({
'slug':'formateur-json','toolId':'json-formatter','category':'dev-seo',
...
E.append({
'slug':'url-encode-decode','toolId':'url-encode-decode','category':'dev-seo',
...
E.append({
'slug':'css-gradient','toolId':'css-gradient-generator','category':'dev-seo',
...
E.append({
'slug':'markdown-preview','toolId':'markdown-preview','category':'dev-seo',
...
E.append({
'slug':'nettoyeur-url-tracking','toolId':'url-cleaner','category':'dev-seo',
...
E.append({
'slug':'compteur-mots','toolId':'word-counter','category':'text-tools',
...
E.append({
'slug':'convertisseur-casse','toolId':'case-converter','category':'text-tools',
...
E.append({
'slug':'lorem-ipsum','toolId':'lorem-ipsum-generator','category':'text-tools',
...
E.append({
'slug':'base64','toolId':'base64-encode-decode','category':'text-tools',
...
E.append({
'slug':'comparateur-texte','toolId':'text-diff-checker','category':'text-tools',
...
E.append({
'slug':'separateur-nom-prenom','toolId':'name-splitter','category':'text-tools',
...
E.append({
'slug':'generateur-qr-code','toolId':'qr-code-generator','category':'generators',
...
E.append({
'slug':'generateur-mot-de-passe','toolId':'password-generator','category':'generators',
...
E.append({
'slug':'generateur-hash','toolId':'hash-generator','category':'generators',
...
E.append({
'slug':'color-picker','toolId':'color-picker','category':'generators',
...
E.append({
'slug':'generateur-lien-whatsapp','toolId':'whatsapp-link','category':'generators',
...
E.append({
'slug':'generateur-uuid-guid','toolId':'uuid-generator','category':'generators',
...
E.append({
'slug':'generateur-nombres-aleatoires','toolId':'random-number-generator','category':'generators',
...
E.append({
'slug':'convertisseur-couleurs','toolId':'color-converter','category':'generators',
...
E.append({
'slug':'calculateur-imc','toolId':'bmi-calculator','category':'calculators',
...
E.append({
'slug':'calculateur-age','toolId':'age-calculator','category':'calculators',
...
E.append({
'slug':'calculateur-pourcentage','toolId':'percentage-calculator','category':'calculators',
...
E.append({
'slug':'convertisseur-unites','toolId':'unit-converter','category':'calculators',
...
E.append({
'slug':'calculateur-dosage-beton','toolId':'concrete-calculator','category':'calculators',
...
E.append({
'slug':'calculateur-frais-kilometriques','toolId':'mileage-calculator','category':'calculators',
...
E.append({
'slug':'chronometre','toolId':'stopwatch','category':'calculators',
...
E.append({
'slug':'timer-pomodoro','toolId':'pomodoro-timer','category':'calculators',
...
E.append({
'slug':'calculateur-tva','toolId':'vat-calculator','category':'calculators',
...
E.append({
'slug':'calculateur-pourboire','toolId':'tip-calculator','category':'calculators',
